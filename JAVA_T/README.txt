...
a persistence unit "JAVA_TPersistenceUnit" which uses the JakartaEE default database.
...
The configuration can be found in "JAVA_T/pom.xml":
...
artifact ("JAVA_T.war") is already built. You can build
